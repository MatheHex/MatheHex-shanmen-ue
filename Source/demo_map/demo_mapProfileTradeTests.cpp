...
bool FProfileTrade01::RunTest(const FString&)
{
	...
	const TArray<int64> Prices = { 100, 200, 400, 800, 100, 200, 400, 800, 80, 120, 30, 60, 120, 45, 30, 100 };
	...
	TestTrue(TEXT("Catalog is exactly the current ordered purchasable registry projection"), bExact);
	return true;
}
