...
namespace
{
	...
	/**
	 * P36/P37 prove one accepted standard root Move to the target family frozen
		...
		FString& OutError)
	{
		...
		{
			OutError = TEXT("P36/P37 require one exact accepted standard Move(1) with a frozen child/BaseQuick target mode.");
			return false;
		}
