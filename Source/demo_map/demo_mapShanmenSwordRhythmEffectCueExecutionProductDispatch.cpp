...
{
	Fdemo_mapShanmenSwordRhythmEffectCueExecutionProductDispatchResult Result;
	Result.Projection =
	...
	if (!Result.IsSuccess())
	{
		...
		Result.Diagnostic = TEXT(
			"Current Product dispatch completed without consistent projection and transaction evidence.");
		return Result;
	}
	Result.Diagnostic = Result.Transaction.Diagnostic;
	return Result;
