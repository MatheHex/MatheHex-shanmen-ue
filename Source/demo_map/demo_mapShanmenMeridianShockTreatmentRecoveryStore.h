...
/**
 * Complete Run-scoped persistence document for committed Meridian Shock
 * treatment proofs. It contains no item quantity, inventory projection or
...
/**
 * Sole persistence owner for condition-domain Meridian Shock treatment proofs.
 * Every mutation is canonicalized, written through a verified temporary file,
 * backed up, atomically replaced on the same volume and read back before it is
