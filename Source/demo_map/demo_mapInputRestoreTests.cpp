...
bool FInputRestore32::RunTest(const FString&) { TestEqual(TEXT("Chest frozen capacity"), Fdemo_mapSearchContainerPrototypeConfig::ChestPrototypeCapacity, 6); TestEqual(TEXT("Unified action registry count"), Fdemo_mapInputActionRegistry::GetExactDefaultActions().Num(), 29); return true; }
