...
void Ademo_mapV3ProgressionManager::RunWorldInteractionAutomation()
{
	...
	if (!Items.IsValid() || !PlayerPawn.IsValid() || Fdemo_mapItemDefinitions::GetAll().Num() != 40 || Chests.Num() != 3 || InitialWorldItems.Num() != 3 || Items->GetWorldActorCount() != 3) { Fail(TEXT("initial V3 foundation.")); return; }
	FString Error;
